const { createQuiz, getAllQuizzes, getSubByCategory, getSubById } = require("../services/index");
...
//      subject by its id
const getSubByIdHandler = async (req, res) => {
    const { id } = req.params;
...
module.exports =  { createQuizHandler, allQuizzesHandler, getSubsByCatHandler, getSubByIdHandler };
